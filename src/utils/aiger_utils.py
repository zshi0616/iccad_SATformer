...
def cnf_to_xdata(cnf_filename, tmp_aig_filename, tmp_aag_filename, gate_to_index={'PI':0, 'AND':1, 'NOT':2}):
...
def aig_to_cnf(data, edge_index, gate_to_index={'PI':0, 'AND':1, 'NOT':2}, const_0=[], const_1=[]):
    # Find PO and Get fanin/fanout list 
    fanin_list = []
    fanout_list = []
    po_idx = 0
    for x_data_info in data:
        fanin_list.append([])
        fanout_list.append([])
